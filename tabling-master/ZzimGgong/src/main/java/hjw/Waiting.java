...
public class Waiting {
		...
		public Waiting(String resnum, String userEmail, String wstarttimeS, int waitingNum, int waitingPerson,
				String cancle, String enterCheck) {
			this.resnum = resnum;
			this.userEmail = userEmail;
		...
		public void setWstarttimeS(String wstarttime) {
			this.wstarttimeS = wstarttime;
		}
